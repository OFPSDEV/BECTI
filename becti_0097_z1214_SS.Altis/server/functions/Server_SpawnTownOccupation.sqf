...
switch (true) do {
	...
	case (_value > 30 && _value <= 50) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["VEHICLE_MOTORIZED", 1, 1]],[ ["VEHICLE_MECHANIZED", 1, 1]]];
	};
	case (_value > 50 && _value <= 75) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIER_AA", 1, 65], ["SOLDIER_MEDIC", 2], ["SOLDIER_MG", 2], ["SOLDIER_AR", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SNIPERS", 1, 55]], [["VEHICLES_LIGHT", 2, 5], ["VEHICLE_APC", 1, 1], ["VEHICLES_AA_LIGHT", 1, 1]]];
	};
	case (_value > 75 && _value <= 100) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIERS_AT_MEDIUM", 1, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 70], ["SOLDIERS_SNIPERS", 1, 70]], [["VEHICLES_LIGHT", 1, 7], ["VEHICLES_MEDIUM", 1, 3], ["VEHICLES_HEAVY", 1, 1], ["VEHICLES_AA_LIGHT", 1, 3]]];
	};
	case (_value > 100 && _value <= 150) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 80], ["SOLDIERS_AT_HEAVY", 2, 50], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 70], ["SOLDIERS_SPECOPS", 1]], [["VEHICLES_LIGHT", 1, 15], ["SOLDIERS_SNIPERS", 1, 75], ["VEHICLES_MEDIUM", 1, 10], ["VEHICLES_HEAVY", 1, 3], ["VEHICLES_AA_LIGHT", 1, 6]]];
	};
	case (_value > 150 && _value <= 200) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 70], ["SOLDIERS_AT_MEDIUM", 2, 65], ["SOLDIERS_AT_HEAVY", 2, 60], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 80]], [["VEHICLES_LIGHT", 1, 20], ["VEHICLES_MEDIUM", 1, 12], ["VEHICLES_HEAVY", 1, 5], ["VEHICLES_AA_LIGHT", 1, 10]]];
	};
	case (_value > 200 && _value <= 250) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 55], ["SOLDIERS_AT_MEDIUM", 2, 65], ["SOLDIERS_AT_HEAVY", 2, 65], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 85]], [["VEHICLES_LIGHT", 1, 25], ["VEHICLES_MEDIUM", 1, 15], ["VEHICLES_HEAVY", 1, 8], ["VEHICLES_AA_LIGHT", 1, 13]]];
	};
	case (_value > 250 && _value <= 300) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 50], ["SOLDIERS_AT_MEDIUM", 2, 70], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 90]], [["VEHICLES_LIGHT", 2, 30], ["VEHICLES_MEDIUM", 1, 18], ["VEHICLES_HEAVY", 1, 10], ["VEHICLES_AA_LIGHT", 1, 15]]];
	};
	case (_value > 300 && _value <= 350) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 45], ["SOLDIERS_AT_MEDIUM", 2, 75], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 95]], [["VEHICLES_LIGHT", 2, 35], ["VEHICLES_MEDIUM", 1, 25], ["VEHICLES_HEAVY", 1, 13], ["VEHICLES_AA_LIGHT", 1, 18]]];
	};
	case (_value > 350 && _value <= 400) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 40], ["SOLDIERS_AT_MEDIUM", 1, 80], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 40], ["VEHICLES_MEDIUM", 2, 28], ["VEHICLES_HEAVY", 1, 15], ["VEHICLES_AA_LIGHT", 1, 20]]];
	};
	case (_value > 400 && _value <= 450) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 37], ["SOLDIERS_AT_MEDIUM", 1, 82], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 45], ["VEHICLES_MEDIUM", 2, 30], ["VEHICLES_HEAVY", 1, 18], ["VEHICLES_AA_LIGHT", 1, 20]]];
	};
	case (_value > 450) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 35], ["SOLDIERS_AT_MEDIUM", 1, 84], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 50], ["VEHICLES_MEDIUM", 2, 35], ["VEHICLES_HEAVY", 1, 20], ["VEHICLES_AA_LIGHT", 1, 20]]];
	};
};
