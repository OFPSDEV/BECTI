...
switch (true) do {
	...
	case (_value > 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 5], ["GUER_VEHICLES_MEDIUM", 2, 25], ["GUER_VEHICLES_HEAVY", 2, 60], ["GUER_VEHICLES_AA_LIGHT", 1, 20]]
		];
	};
};
