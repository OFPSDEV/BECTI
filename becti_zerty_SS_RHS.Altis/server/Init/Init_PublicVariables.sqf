...
with missionNamespace do {
	...
	CTI_PVF_Request_Join = {
		...
		_join = true;
		_was_jailed = false;
		_end = -1; // -1 signifies true in this condition, a positive value gives the fail message
		_endWith = "";
...
//			_imbalance = 0; // Variable overrride 
		...
		[["CLIENT", _client], "Client_JoinRequestAnswer", [_end, _was_jailed]] call CTI_CO_FNC_NetSend;
	};
