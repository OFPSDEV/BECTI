...
if (typeOf _vehicle in (CTI_VEHICLES_HOOKERS_EX)) then {  //added this if statement SS83
...
if (typeOf _vehicle in (CTI_VEHICLES_RETEXTURE)) then { 
    switch (_side) do { 
        /*case west: { //old one ss83
            _vehicle setObjectTextureGlobal  [0,"#(argb,8,8,3)color(0.8,0.7,0.5,0.2)"]; 
            _vehicle setObjectTextureGlobal  [1,"#(argb,8,8,3)color(0.8,0.7,0.5,0.2)"]; 
            _vehicle setObjectTextureGlobal  [2,"#(argb,8,8,3)color(0.8,0.7,0.5,0.2)"]; 
        }; 
        case east: {   
            _vehicle setObjectTextureGlobal [0,"#(argb,8,8,3)color(0.125,0.125,0.125,0.5)"]; 
            _vehicle setObjectTextureGlobal [1,"#(argb,8,8,3)color(0.125,0.125,0.125,0.5)"]; 
            _vehicle setObjectTextureGlobal [2,"#(argb,8,8,3)color(0.125,0.125,0.125,0.5)"]; 
        }; */
