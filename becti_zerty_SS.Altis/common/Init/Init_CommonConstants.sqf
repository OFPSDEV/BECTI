...
CTI_BASE_CONSTRUCTION_RANGE = CTI_BASE_AREA_RANGE / 2; //--- Determine how far the commander may be from the HQ to build
...
CTI_VEHICLES_SALVAGE_INDEPENDENT_MAX = 3; //--- Maximum amount of Independent Salvage Trucks which may be present per side
...
CTI_MARKERS_TOWN_AREA_RANGE = 325; //--- Controls award area. Made larger than the capture radius, so you can safely wait for capture money without triggering capture.
...
CTI_CONSTRUCTIONCAM_ZOOM_MAX = 60;
