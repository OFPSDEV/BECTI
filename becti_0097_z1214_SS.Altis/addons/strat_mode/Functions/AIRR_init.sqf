...
if (CTI_isServer) then{
	with missionnamespace do {
		AIRR_HANDLER = compileFinal preprocessFileLineNumbers "Addons\Strat_mode\Functions\AIRR_handler.sqf";
		AIRR_OBJ_HANDLER = compileFinal preprocessFileLineNumbers "Addons\Strat_mode\Functions\AIRR_obj_handler.sqf";
