...
_times = _times 			+ [90];
_placements = _placements 	+ [[90, 20]];
_specials = _specials       + [[["DMG_Alternative"], ["DMG_Reduce", 5],["Connected"]]];
...
_specials = _specials		+ [[["DMG_Alternative"], ["DMG_Reduce", 3]]];
...
_headers = _headers 		+ [["Tower", [["DMG_Reduce", 6]]]];
...
//_headers = _headers 		+ [["High Wall (Concrete)",[["CanAutoAlign", 4.6, 0]]]];   HAD TO REMOVE IT DOESN'T BLOW UP
