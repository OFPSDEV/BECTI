...
switch (true) do {
	...
	case (_value > 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 5], ["GUER_VEHICLES_MEDIUM", 2, 75], ["GUER_VEHICLES_HEAVY", 2, 20], ["GUER_VEHICLES_AA_LIGHT", 1, 70]]
		];
	};
};
