...
class CTI_RscVideoSettingsMenu {
	...
	class controlsBackground {
		...
		class CTI_Menu_GridFrame : CTI_Menu_InfoListFrame {
			y = "SafeZoneY + (SafezoneH * 0.485)";//7.65
			h = "SafeZoneH * 0.07";
		};
	...
	class controls {
		...
		class CTI_Menu_Video_ViewDistanceLabel : RscText {
			...
			text = "Infantry View Distance: 1000m";
		...
		//csm
		//Ground Vehicle View
		class CTI_Menu_Video_GroundViewDistanceLabel : CTI_Menu_Video_ViewDistanceLabel {
			idc = 150010;
			y = "SafeZoneY + (SafezoneH * 0.34)";
			
			text = "Ground Vehicle & Ship View Distance: 1000m";
		};
		class CTI_Menu_Video_GroundViewDistance : CTI_Menu_Video_ViewDistance {
			idc = 150011;
			
			y = "SafeZoneY + (SafezoneH * 0.375)";
			
			onSliderPosChanged = "['onGroundViewSliderChanged', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_VideoSettingsMenu.sqf'";
		};
		// Aircraft View
		class CTI_Menu_Video_AirViewDistanceLabel : CTI_Menu_Video_ViewDistanceLabel {
			idc = 150012;
			y = "SafeZoneY + (SafezoneH * 0.405)";
			
			text = "Aircraft View Distance: 1000m";
		};
		class CTI_Menu_Video_AirViewDistance : CTI_Menu_Video_ViewDistance {
			idc = 150013;
			
			y = "SafeZoneY + (SafezoneH * 0.44)";
			
			onSliderPosChanged = "['onAirViewSliderChanged', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_VideoSettingsMenu.sqf'";
		};
		// Object percentage
		...
		// Enable auto view distance
		class CTI_Menu_AutoViewDistance : RscButton {
			idc = 150014;
			...
			text = "";
			action = "['onAutoViewDistancePressed'] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_VideoSettingsMenu.sqf'";
		};
		// end csm
...
class CTI_RscCommandMenu {
	...
	class controls {
		...
		class CTI_Control_VoteMenu : CTI_Control_Resources {
			...
			y = "SafeZoneY + (SafezoneH * 3.67)"; //--- Render out
...
class CTI_RscConstructionCamera {
